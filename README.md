# Education Project (DATA 5100-01) - School Poverty, Institutional Resources, and Academic Achievement: A Mediation Analysis of U.S. High Schools
...
**REPRODUCIBILITY NOTE:** We keep a tiny .gitattributes file in the data/ folder so GitHub stores our large CSVs with Git LFS because uploading a 465 mb from browser is not feasible because the limit is 25 mb. Also, it’s not code, just a pointer that keeps clones fast and ensures the exact dataset versions are preserved for reproducible results.
